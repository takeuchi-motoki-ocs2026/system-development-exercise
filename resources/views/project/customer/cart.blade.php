...
<div class="container cart-page">
    ...
    @else
      ...
      @foreach(session('customer_cart') as $key => $item)
        <div class="history-row">
          ...
          <form action="{{ url('/project/cart/delete/'.$key) }}" method="POST">
            @csrf
          ...
          <div class="history-item">
            ...
            <div class="item-count-control">
              ...
              <form action="{{ url('/project/cart/update/'.$key) }}" method="POST">
              @csrf
  ...
  <div class="cart-buttons">
    ...
    @else
      <form action="{{ url('/project/cart/clear') }}" method="POST">
      @csrf
