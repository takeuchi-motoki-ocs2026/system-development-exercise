...
<div class="container">
    ...
    <div class="menu-btn" onclick="location.href='{{ route('projectstock-status') }}'">
        在庫状況
    </div>
    ...
    <div class="menu-btn"
        onclick="location.href='{{ route('projectmenu-add') }}'">
    ...
    <div class="menu-btn"
        onclick="location.href='{{ route('projectmenu-edit-list') }}'">
